...
const ShowProject = ({ params }) => {
  ...
  return (
    <div className="space-y-8 px-4 sm:px-6 lg:px-8">
      <div className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 rounded-2xl p-4 sm:p-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm rounded-lg bg-green-500 text-white hover:bg-green-600"
            >
